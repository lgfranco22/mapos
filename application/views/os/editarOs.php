                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <label for="imei1">IMEI 1</label><br>
                                            <input id="imei1" autocomplete="off" class="span12" type="text" name="imei1" value="<?php echo $result->imei1 ?>" />
                                        </div>
                                        <div class="span3">
                                            ...
                                            <label for="imei2">IMEI 2</label><br>
                                            <input id="imei2" autocomplete="off" class="span12" type="text" name="imei2" value="<?php echo $result->imei2 ?>" />
                                        </div>
                                        <div class="span3">
                                            ...
                                            <input id="sn" autocomplete="off" class="span12" type="text" name="sn" value="<?php echo $result->sn ?>" />
                                        </div>
                                        <div class="span3">
